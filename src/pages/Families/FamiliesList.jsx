...
const FamiliesList = () => {
  const [activeAccordion, setActiveAccordion] = useState(0); // State to track active accordion item

  const handleAccordionClick = (index) => {
    setActiveAccordion(index === activeAccordion ? -1 : index); // Toggle active accordion item
  };
              ...
              <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <i style={{color:"black",marginRight:"10px"}} className={`fas fa-arrow-down ${activeAccordion === 0 ? "" : "collapsed"}`}></i>
                  </div>
                  <div
                    id="collapseOne"
